...
for CAMERA in /dev/video*; do
	...
	fswebcam -r 1920x1080 -d $CAMERA --skip 20 --set "Gamma"=100 --set "Hue"=0 --set "Sharpness"=2 --set "Saturation"=64 --set "White Balance Temperature"=6500 --set "Focus, Auto"=False --set "Focus (absolute)"=0 --set "Brightness"=-60 $FILE_PATH
